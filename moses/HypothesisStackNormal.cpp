...
{
  VERBOSE(3," Into AddPrune  m_worstScore : "<< m_worstScore<<endl);	
...
bool HypothesisStackNormal::RescoreAddPrune(Hypothesis *Newhypo, Hypothesis *Oldhypo)
{
