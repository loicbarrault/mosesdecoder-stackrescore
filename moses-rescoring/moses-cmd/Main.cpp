...
public:
  ...
  void Run() {
    ...
    VERBOSE(2,"Translating line " << m_lineNumber << "  in thread id " << pthread_self() << std::endl);
#endif
    ...
    VERBOSE(2, "Line " << m_lineNumber << ": Translation took " << translationTime << " seconds total" << endl);
  }
